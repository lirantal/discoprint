...
Use exactly one of `--variables` and `--variables-file`. Read [`variables-and-media.md`](../../../../apm_modules/heygen-com/hyperframes/skills/hyperframes-core/references/variables-and-media.md#variables) for the composition-side contract.
