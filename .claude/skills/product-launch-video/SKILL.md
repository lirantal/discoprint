...
| `[../hyperframes-creative/references/design-spec.md](../../../apm_modules/heygen-com/hyperframes/skills/hyperframes-creative/references/design-spec.md)`                                                    | Step 2: apply brand tokens correctly.                                                                    |
...
| `[../media-use/audio/references/tts.md](../../../apm_modules/heygen-com/hyperframes/skills/media-use/audio/references/tts.md)`                                                                              | Step 3.1: choose or understand TTS providers and voices.                                                 |
